...
public extension UIView{
    public func anchor(top: NSLayoutYAxisAnchor?, bottom: NSLayoutYAxisAnchor?, left: NSLayoutXAxisAnchor?, right: NSLayoutXAxisAnchor?, topPadding: CGFloat, bottomPadding: CGFloat, leftPadding: CGFloat, rightPadding: CGFloat, width: CGFloat, height: CGFloat ) {
   ...
   public func fullAnchor(superView: UIView) {
   ...
   public func centerAnchor(superView: UIView, width: CGFloat, height: CGFloat) {
   ...
   public func minimizeAnimation(scaleX: CGFloat, scaleY: CGFloat) {
   ...
   public func rotateAnimation(angle: CGFloat, duraation: Double, completion: @escaping ()->()){
   ...
   public func moveAnimation(dx: CGFloat?, completion: @escaping ()->()) {
   ...
   public func setShadow(shadowColor: UIColor, shadowOpacity: Float, offsetWidth width: CGFloat, offsetHeight height: CGFloat){
        self.layoutIfNeeded()
   ...
   public func getShadowArguments() -> (shadowColor: UIColor, shadowOpacity: Float, offsetWidth: CGFloat, offsetHeight: CGFloat){
        self.layoutIfNeeded()
        return (
